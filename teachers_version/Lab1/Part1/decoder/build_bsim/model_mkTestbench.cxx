...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_rl_opcode_test;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_rl_opcode_test;
	 DEF_INST_top_DEF_CAN_FIRE_RL_rl_opcode_test = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_rl_opcode_test = DEF_INST_top_DEF_CAN_FIRE_RL_rl_opcode_test;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_rl_opcode_test)
	   INST_top.RL_rl_opcode_test();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_rg_testing_phase.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_rg_insn.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_de_insn.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_de_rd.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_de_rs1.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_de_rs2.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
void MODEL_mkTestbench::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTestbench_instance->INST_decoder.set_clk_0)("CLK");
...
time_t MODEL_mkTestbench::get_creation_time()
{
  ...
  /* Thu Jun  8 08:01:22 UTC 2023 */
  return 1686211282llu;
}
